...
export const TOOL_DETAIL_UI_TRANSLATIONS: Record<string, { zh: string; en: string }> = {
  ...
  pricingSeeOfficial: { zh: '具体价格与套餐以官网为准', en: 'See the official site for pricing details' },
  webmasterBadge: { zh: '站长', en: 'Official' },
  visitOfficial: { zh: '前往官网', en: 'Visit official site' },
