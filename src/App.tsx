                  ...
                  <ErrorBoundary>
                    <Suspense fallback={<PageLoader />}>
                      <Routes>
                        ...
                        {/* English routes (SEO-friendly /en prefix) */}
                        <Route path="/en" element={
                          <PageTransition type="fade" duration={200}>
                            <HomePage />
                          </PageTransition>
                        } />
                        <Route path="/en/tools" element={
                          <PageTransition type="fade" duration={200}>
                            <ToolsPage />
                          </PageTransition>
                        } />
                        <Route path="/en/tools/:toolId" element={
                          <PageTransition type="fade" duration={200}>
                            <ToolDetailPage />
                          </PageTransition>
                        } />
                        ...
                        <Route path="/en/favorites" element={<Navigate to="/en/profile?tab=favorites" replace />} />
